...
public class GetMyPostsCallbackHandler implements CallbackQueryHandler {
    ...
    public GetMyPostsCallbackHandler(UserDataCache userDataCache, SearchPostsService myPostsService) {
    ...
    public SendMessage handleCallbackQuery(CallbackQuery callbackQuery) {
        PostSearchCache postSearchCache = userDataCache.getSearchPostsCache(callbackQuery.getFrom().getId(), PostSearchCase.MY_POSTS);
